...
def build_about():
    ...
    body = f"""    <section class="section container">
      <p class="lead" data-reveal>Oscar Leo is a professional photographer based in Vancouver, British
         Columbia, working across headshots and portraiture, events, brand and marketing content,
         live music, weddings and behind-the-scenes production photography. The work covers both
         sides of a portrait — candid, real-life moments as they happen, and considered studio
         work made with direction — and every commission is quoted from published prices before
         you make contact.</p>
    </section>
    ...
    <section class="section container">
      <div class="grid-2">
        ...
        <div class="prose" data-reveal style="--i:1">
          ...
          <p>Whether it's a candid frame caught as it happens or a portrait built deliberately in the
             studio, the intent is the same: exceptional quality, and a personal touch in every shot.</p>
        </div>
      </div>
    </section>
