      ...
      <div class="grid-2">
        ...
        <div class="price-card" data-reveal style="--i:1">
          ...
          <form class="form" action="mailto:contact@oscarleo.photography">
            ...
            <p class="hint" style="margin-top: var(--space-s)">Or email directly:
               <a class="text-link" href="mailto:contact@oscarleo.photography">contact@oscarleo.photography</a></p>
          </form>
        </div>
      </div>
    </section>
